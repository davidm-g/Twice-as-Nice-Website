...
INSERT OR IGNORE INTO messages (id, sender, receiver, item_id, message_text, timestamp) VALUES
(1, 'asmith', 'jdoe', 1, 'Hello, is the item still available?', strftime('%s','now')),
(2, 'jdoe', 'asmith', 1, 'Yes, it is still available.', strftime('%s','now')),
(3, 'asmith', 'jdoe', 1, 'Great, I would like to buy it.', strftime('%s','now')),
(4, 'jdoe', 'asmith', 1, 'Sure, I will prepare it for you.', strftime('%s','now')),
(5, 'bturner', 'asmith', 2, 'Is this the latest model?', strftime('%s','now')),
(6, 'asmith', 'bturner', 2, 'Yes, it is the latest model.', strftime('%s','now')),
(7, 'jdoe', 'asmith', 2, 'Hello, is the item still available?', strftime('%s','now')),
(8, 'asmith', 'jdoe', 2, 'Yes, it is still available.', strftime('%s','now')),
(9, 'jdoe', 'asmith', 2, 'Great, I would like to buy it.', strftime('%s','now')),
(10, 'asmith', 'jdoe', 2, 'Sure, I will prepare it for you.', strftime('%s','now'));
...
INSERT OR IGNORE INTO item_categories (item_id, category_id, subcategory_id) VALUES
    ...
    (7, 1, (SELECT id FROM subcategories WHERE name = 'Other')), -- Samsung Galaxy Buds Pro belongs to Other
    (8, 1, (SELECT id FROM subcategories WHERE name = 'Other')), -- Sony WH-1000XM5 Headphones belongs to Other
    (9, 3, (SELECT id FROM subcategories WHERE name = 'Shoes')), -- Nike AlphaFly 3 belongs to Shoes
    (10, 4, (SELECT id FROM subcategories WHERE name = 'Other')); -- Ikea Desk belongs to Home & Kitchen
